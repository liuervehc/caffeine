...
#define PMC_BASE                     ((uintptr_t)0x7000E400)
...
#define APBDEV_PMC_SCRATCH0_0        MAKE_PMC_REG(0x050)
#define APBDEV_PMC_SCRATCH1_0        MAKE_PMC_REG(0x054)
...
#define APBDEV_PMC_SCRATCH31_0       MAKE_PMC_REG(0x118)
#define APBDEV_PMC_SCRATCH32_0       MAKE_PMC_REG(0x11C)
